...
<div class="footer">
    ...
    <p>SFAC-Bacoor Campus | Online Grading System | All Rights Reserved &copy; <?php echo date('Y') ?><small style="float: right; margin-right: 5px">COMPSOC Batch 19-20</small></p>
</div>
<?php
        include "../../includes/db.php";
