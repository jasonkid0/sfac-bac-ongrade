...
<body class="hold-transition skin-blue sidebar-mini">
            ...
            <div class="row">
              ...
              ?>
                            <h2 class="box-title"><strong>Section(s) for
                                    <?php echo $_GET['code'] . ' - ' . $_GET['class_desc']; ?></strong></h2>
                            <?php } ?>
  ...
  AND semester = '$_SESSION[active_sem]'"
                  ...
                  <td>' . $row['room'] . '</td>
                  <td><center>
                    <a href="class_stud.php?code=' . $_GET['code'] . '&section=' . $row['section'] . '&class_desc=' . $_GET['class_desc'] . '" class="btn btn-danger">Enter Grade | Enter Absences | Transfer Section</a>
                    <a href="../forms/rog.php?code=' . $_GET['code'] . '&section=' . $row['section'] . '&faculty_id=' . $_GET['faculty_id'] . '&class_desc=' . $_GET['class_desc'] . '" class="btn btn-success">View ROG</a>
