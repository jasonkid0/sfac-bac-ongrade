...
$faculty_id = ($_SESSION['role'] == "Faculty Staff")? $_SESSION['userid'] : $_GET['faculty_id']; 
?>
<!DOCTYPE html>
<html>
<!-- ============================================HEAD CSS LINKS============================================= -->
...
// while($row = mysqli_fetch_array($que)){
  echo'<tr>
                 ...
                 <td><a href="section.php?code=' . $row1['class_code'] . '&faculty_id=' . $faculty_id . '&class_desc=' . $row1['subj_desc'] . '" class="btn btn-primary">View Class</a></td>
                </tr>';
}
